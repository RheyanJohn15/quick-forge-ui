<template>
  <div class="w-full grid grid-cols-5 gap-4 p-8 bg-white h-screen">
    <article class="group h-96 overflow-hidden rounded-lg border-2 border-gray-200 border-opacity-60 shadow-lg">
